...
(function() {
	...
	function sc(a) {
		...
		return R(`<div id="drawer">Drawer</div><div id="codelab-title"><div id="codelab-nav-buttons"><a href="' + hc(mc(a)) +
			...
			<a href="#" onclick='window.parent.location.href="${homePageUrl}"' id="done" hidden title="Codelab complete">Done</a></div></div></div>`);
	}
	...
	function uc(a) {
		...
		return R('<div id="remaining_time" class="time-remaining" title="Time remaining"><i class="material-icons">access_time</i>' + (1 == a ?
			gc(a) + " min remaining" : gc(a) + " mins remaining") + "</div>" + releaseDate)
	}
	...
	function vc(a) {
		...
		c += "</ol></div>" + (a ? '<div id="feedback" class="metadata"><a target="_blank" href="' + hc(mc(a)) +
		...
		if (a.hasAttribute("selected")) {
			...
			b && !isNaN(b)) {
				...
				if (-1 === a.h) a.c[b].setAttribute("selected", "");
					...
					a.h < b ?
						(c.transform = "translate3d(110%, 0, 0)", d.transform = "translate3d(-110%, 0, 0)") : (c.transform =
							"translate3d(-110%, 0, 0)", d.transform = "translate3d(110%, 0, 0)");
					var g = [{
						ka: "transform",
						duration: .5,
						ea: 0,
